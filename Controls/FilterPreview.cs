...
namespace DHHTA
{
    ...
    public class FilterPreview : System.Windows.Forms.Control
    {
        ...
        public FilterPreview( )
        {
            ...
            //cursorHand = new Cursor( assembly.GetManifestResourceStream( "DHHTA.Resources.harrow.cur" ) );
          // cursorHandMove = new Cursor( assembly.GetManifestResourceStream( "DHHTA.Resources.hmove.cur" ) );
        }
